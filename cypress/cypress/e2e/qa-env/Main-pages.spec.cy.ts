...
describe('Main pages', () => {
  ...
  qase(
    5,
    it.skip('live-casino landing page', () => {
  ...
  qase(
    8,
    it.skip('live-casino lobby page', () => {
      navBarHelper.openLiveCasinoLanding();
      loginPageHelper.checkLoaderAppearing();
      cy.scrollTo('center');
  ...
  qase(
    6,
    it.skip('live-slots landing page ', () => {
  ...
  qase(
    9,
    it.skip('live-slots (slots) lobby page (modern view)', () => {
      navBarHelper.openLiveSlotsLanding();
      loginPageHelper.checkLoaderAppearing();
      cy.scrollTo('center');
  ...
  qase(
    83,
    it.skip('live-slots (jackpots) lobby page (modern view)', () => {
      navBarHelper.openLiveSlotsLanding();
      loginPageHelper.checkLoaderAppearing();
      cy.scrollTo('center');
  ...
  qase(
    12,
    // liveSlotsLobbyPageHelper.searchWithResultsSlotsClassicView needs refactoring
    it.skip('live-slots lobby page (classic view) from slots landing', () => {
      navBarHelper.openLiveSlotsLanding();
      loginPageHelper.checkLoaderAppearing();
      cy.scrollTo('center');
      liveSlotsHelper.searchBarLiveSlots(slotsBtnsTitles.classicView);
  ...
  qase(
    121,
    it.skip('live-slots lobby page (classic view) from slots lobby', () => {
      cy.visit('/live-slots', { failOnStatusCode: false });
      loginPageHelper.checkLoaderAppearing();
  ...
  qase(
    52,
    // navigation with navbar needs refactoring
  ...
  qase(
    ...
    it('Filter games (e-games)', () => {
      cy.visit('/egames', { failOnStatusCode: false });
      cy.window().then((window) => {
        window.localStorage.setItem('privacypolicyagree', '1');
      });
      eGamesHelper.elements.loader().click({ timeout: 5000 });
      loginPageHelper.closeModalWindow();
  ...
  qase(
    85,
    it.skip('Login page invalid PIN', () => {
      navBarHelper.clickLoginBtn();
  ...
  qase(
    ...
    it('Forgot page redirect to Login page', () => {
      // navBarHelper.clickLoginBtn();
      cy.visit('/login', { failOnStatusCode: false });
      cy.get('body', { timeout: 5000 }).click({ force: true });
      loginPageHelper.closeModalWindow();
      cy.window().then((window) => {
        window.localStorage.setItem('privacypolicyagree', '1');
      });
  ...
  qase(
    89,
    it.skip('Registration page invalid PIN', () => {
      navBarHelper.clickRegBtn();
  ...
  qase(
    ...
    it('Registration page redirect to login page', () => {
      ...
      cy.get('body', { timeout: 5000 }).click({ force: true });
      loginPageHelper.closeModalWindow();
      registrationPageHelper.checkBodyText('Register');
  ...
  qase(
    105,
    it.skip('Profile info page invalid PIN changing', () => {
      scenariosHelper.loginByPhone(validPhones[1], 1);
      navBarHelper.openLangBtn();
      sideBarHelper.openSideBarDropdown();
      sideBarHelper.openProfileInfo();
...
describe('Scenarios Suit', () => {
  ...
  qase(
    99,
    it.skip('Remove from favorites live casino', () => {
      scenariosHelper.loginByPhone(validPhones[1], 1);
      navBarHelper.openLiveCasinoLanding();
      liveCasinoHelper.urlCasino();
      liveCasinoHelper.loggedInFavs();
  ...
  qase(
    149,
    it.skip('Open last visited page after login again', () => {
      scenariosHelper.loginByPhone(validPhones[3], 1);
      navBarHelper.openLiveCasinoLanding();
      liveCasinoHelper.urlCasino();
      // liveCasinoHelper.loggedInFavs();
  ...
  qase(
    142,
    it.skip('Open support chat through all the pages', () => {
      const newRandomNumber = generateRandomNumber();
      const newRandomEmail = generateRandomEmail();
...
describe('Switch languages', () => {
  ...
  Cypress._.times(locales.length, (k) => {
    ...
    let qaseID = getQaseID(locale, 150, 20);
    ...
    describe.skip('Logged in user', () => {
      ...
      describe.skip('Logged in profile', () => {
        ...
        qase(
          qaseID++,
          it(`Check "${locale.toUpperCase()}" locale profile withdraw page when logged in`, () => {
            cy.visit(`/profile/balance`);
        ...
        qase(
          qaseID++,
          it(`Check "${locale.toUpperCase()}" locale profile balance page when logged in`, () => {
            cy.visit(`/profile/balance`);
        ...
        qase(
          qaseID++,
          it.skip(`Check "${locale.toUpperCase()}" locale profile page when logged in`, () => {
            cy.visit(`/profile`);
            profileInfoPageHelper.checkLoaderLocale(locale);
